...
Thread.start {
    ...
    if(!instance.getAuthorizationStrategy().getClass().equals(hudson.security.ProjectMatrixAuthorizationStrategy)){
        ...
        println '--> Project-based authorisation strategy already set up'
    }
